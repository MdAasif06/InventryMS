...
export const BlueTitle = ({
  ...
  return (
    <span
      className={`bg-linear-to-br font-serif from-blue-300 via-blue-400 to-blue-600
...
export const SectionLabel = ({
  ...
  return (
    <p
      className={`inline-flex items-center gap-2 text-xs font-semibold text-blue-400
...
export const SectionHeading=({gray,blue}:{gray:string,blue:string})=>{
   return <h2 className="font-serif text-[clamp(2rem,4vw,3rem)] leading-[1.1]
   tracking-tight">
